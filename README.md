# A Terribly Weighty Subject (C++)

## Background

You can find the instructions for this lab [here](https://morethanequations.com/Computer-Science/Labs/a-terribly-weighty-subject). Update `weight.cpp` with the code for your submission.
